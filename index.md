...
# Second Milestone
 My second milestone was getting readings from the accelerometer, connecting the two ESP32s, and having one ESP32 display what the car should be doing on the serial monitor from the accelerometer input on a remote ESP32. The accelerometer was able to display 
